...
import com.leo.rpc.common.cons.RpcConstants;
...
@Slf4j
@Component
public class TinyRpcConsumerPostProcessor implements ApplicationContextAware, BeanClassLoaderAware, BeanFactoryPostProcessor {
     ...
     * 如果 field 被声明了 @TinyRpcReference 注解，通过 BeanDefinitionBuilder 构造 RpcReferenceBean 的定义，并为 RpcReferenceBean 的成员变量赋值，
     * 包括服务类型 interfaceClass、服务版本 serviceVersion、注册中心类型 registryType、注册中心地址 registryAddr 以及超时时间 timeout。
     * 构造完 RpcReferenceBean 的定义之后，会将TinyReferenceBean 的 BeanDefinition 重新注册到 Spring 容器中。
     *
     * @param beanFactory
